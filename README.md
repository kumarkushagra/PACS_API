...
1. **Ensure Server Configuration**: Ensure the server hosting the API is running and accessible at the specified port in `main.py`. Adjust the port number if necessary.
